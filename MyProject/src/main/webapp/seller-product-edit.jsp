		...
		<div id="jewellery_main_slider" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="container">
						<h1 class="fashion_taital">Edit Product</h1>
								...
								<form method="post" action="ProductController"
									...
									<div class="form-outline mb-12">
										<input type="text" id="form3Example1cg"
											class="form-control form-control-lg" name="product_name" value="<%=p.getProduct_name()%>"/>
									...
									<div class="form-outline mb-12">
										<input type="text" id="form3Example3cg"
											class="form-control form-control-lg" name="product_price" value="<%=p.getProduct_price()%>"/>
									...
									<div class="form-outline mb-12">
										<textarea name="product_desc" id="form3Example3cg"
											class="form-control form-control-lg"><%=p.getProduct_desc() %></textarea>
										<label class="form-label" for="form3Example3cg">Product
											Description</label>
									</div>
									<div class="form-outline mb-12">
									...
									<div class="form-outline mb-12">
										<input type="file" name="product_image" /> <label
											class="form-label" for="form3Example3cg">Product
											Image</label>
									</div>
