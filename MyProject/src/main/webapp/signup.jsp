		...
		<div id="jewellery_main_slider" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="container">
						<h1 class="fashion_taital">User Sign Up</h1>
				...
				%>
								<form method="post" action="UserController">
									<div class="form-outline mb-12">
										<select name="usertype"  id="form3Example1cg"
									...
									<div class="form-outline mb-12">
										<input type="text" id="form3Example3cg"
											class="form-control form-control-lg" name="mobile" /> <label
									...
									<div class="form-outline mb-12">
										<input type="password" id="form3Example4cdg"
											class="form-control form-control-lg" name="cpassword" /> <label
