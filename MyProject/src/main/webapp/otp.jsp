		...
		<div id="jewellery_main_slider" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="container">
						<h1 class="fashion_taital">Verify OTP</h1>
								...
								<form method="post" action="UserController">
									...
									<div class="form-outline mb-12">
										<input type="text" id="form3Example3cg"
											class="form-control form-control-lg" name="uotp" /> <label
											class="form-label" for="form3Example3cg">Your OTP</label>
									</div>

									<div class="d-flex justify-content-center">
										<button type="submit" name="action" value="Verify OTP"
											class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Verify OTP</button>
									</div>
