                        ...
                        %>
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <br><br>
                                 <div class="btn_main">
                                 	<div class="seemore_bt"><a href="seller-product-edit.jsp?pid=<%=p.getPid()%>"><input type="button" class="btn btn-primary" value="EDIT"></a></div>
                                    <div class="seemore_bt"><a href="seller-product-delete.jsp?pid=<%=p.getPid()%>"><input type="button" class="btn btn-danger" value="DELETE"></a></div>
                                 </div>
                              </div>
                           </div>
                        <%
