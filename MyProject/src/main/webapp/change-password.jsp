		...
		<div id="jewellery_main_slider" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="container">
						<h1 class="fashion_taital">Change Password</h1>
								...
								<form method="post" action="UserController">
									...
									<div class="form-outline mb-12">
										<input type="password" id="form3Example4cg"
											class="form-control form-control-lg" name="old_password" /> <label
											class="form-label" for="form3Example4cg">Old Password</label>
									</div>
									<div class="form-outline mb-12">
										<input type="password" id="form3Example4cg"
											class="form-control form-control-lg" name="new_password" /> <label
											class="form-label" for="form3Example4cg">New Password</label>
									</div>
									<div class="form-outline mb-12">
										<input type="password" id="form3Example4cg"
											class="form-control form-control-lg" name="cnew_password" /> <label
											class="form-label" for="form3Example4cg">Confirm New Password</label>
									</div>
